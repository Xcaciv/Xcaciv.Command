...
- **Version bump:** All packages now versioned to **3.2.2** (Command, Core, Interface, FileLoader, DependencyInjection, Extensions.Commandline).
- **Documentation:** Updated install/version references to 3.2.2 across package readme and quick reference.
